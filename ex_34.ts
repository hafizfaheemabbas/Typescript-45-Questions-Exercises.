...
let myFavPizza : string [] = ['chicken tikka pizza', 'fajita pizza', 'mexican pizza'];

// for loop

for(let i = 0; i < myFavPizza.length; i ++){
    console.log(`I like to eat ${myFavPizza[i]}`);

}

console.log(`\nI really like to eat pizzas, pizza comes in varity of flavours\n`)